...
//
//                        // Euskera (abreviaturas)
//                        e("K", "KALEA"), e("KAL", "KALEA"), e("KAL.", "KALEA"),
//                        e("ET", "ETORBIDEA"), e("ETORB", "ETORBIDEA"), e("ETORB.", "ETORBIDEA"),
//                        e("BID", "BIDEA"), e("BID.", "BIDEA"),
//                        e("ENP", "ENPARANTZA"), e("ENP.", "ENPARANTZA"),
//                        e("PSK", "PASEALEKUA"), e("PSK.", "PASEALEKUA"),
//                        e("ERREP", "ERREPIDEA"), e("ERREP.", "ERREPIDEA"),
//                        e("HIR", "HIRIBIDEA"), e("HIR.", "HIRIBIDEA"),
//                        e("ZK", "ZEHARKALEA"), e("ZK.", "ZEHARKALEA"),
//                        e("BBG", "BIRIBILGUNEA"), e("BBG.", "BIRIBILGUNEA")
//                ),
//                Set.of(
//                        "CALLE", "AVENIDA", "PLAZA", "CARRETERA", "PASEO", "TRAVESIA",
//                        "CAMINO", "RONDA", "GLORIETA", "BULEVAR",
//
//                        // Euskera (tipos completos)
...
//        Pattern p1Suffix = Pattern.compile("((?:[A-ZÀ-ÿ\\s]+?))\\s+(" + tipos + ")\\b\\s*,?\\s*(\\d+[A-Z]?)\\b");
//        Matcher m1s = p1Suffix.matcher(s);
//        if (m1s.find()) return new StreetParts(m1s.group(2), m1s.group(1).trim(), m1s.group(3));
//
